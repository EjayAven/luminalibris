...
// Fetch data based on the SQL query for materials
$sql = "
    SELECT 
        referenceID,
        title,
...
<body>
    <div class="navbar">
        ...
        <div class="menu">
            ...
            <div class="menu-item">
                ...
                <div class="submenu">
                    <a href="librarian-profile.php">Librarian</a>
                    <hr>
    ...
    <div class="main-content">
        ...
        <div class="header1">
            <span>&emsp;&emsp;&emsp;Catalog</span>
        </div>
    ...
    <script>
        ...
        // Generate Report and Filter Data
        function generateReport() {
            ...
            const filteredData = data.filter(item => {
                ...
                if (filterComplete && item.subject === 'Complete') return true;
                if (filterIncomplete && item.subject === 'Incomplete') return true;
